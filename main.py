...
URL = "https://pixe.la/v1/users/atiksh/graphs/graph2.html"
TODAY = dt.now()
...
def add_pixel():
    endpoint = "https://pixe.la/v1/users/atiksh/graphs/graph2/"
    pixel_add = {
        "date": format_date(),
...
def del_pixel():
    endpoint = f"https://pixe.la/v1/users/atiksh/graphs/graph2/{format_date()}"
